                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-12 col-lg-8 text-center">
                                    ...
                                    <a href="quote" class="btn btn-primary py-md-3 px-md-5 animated slideInRight">Free Quote</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item text-center">
                        <img class="img-fluid bg-light p-2 mx-auto mb-3" src="img/fitback-1.jpg" style="width: 90px; height: 90px;">
                        <div class="testimonial-text text-center p-4">
                            <p>"DormBOO thật sự là một sự lựa chọn tuyệt vời với chúng tôi nói riêng và sinh viên nói chung. DormBOO cho ta lựa chọn kí túc xá tốt nhất và đẹp nhất."</p>
                            <h5 class="mb-1">Trinh Anh Duc</h5>
                            <span class="fst-italic">FPT Student</span>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        <img class="img-fluid bg-light p-2 mx-auto mb-3" src="img/fitback-4.jpg" style="width: 90px; height: 90px;">
                        <div class="testimonial-text text-center p-4">
                            <p>"DormBOO is really a great choice. As a student, when entering university, finding a dormitory is a very difficult task. But when it comes to DormBOO, it's easy. Thank you DormBOO."</p>
                            <h5 class="mb-1">Angela Khanh Linh</h5>
                            <span class="fst-italic">FPT Student</span>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
                        <img class="img-fluid bg-light p-2 mx-auto mb-3" src="img/fitback-2.jpg" style="width: 90px; height: 90px;">
                        <div class="testimonial-text text-center p-4">
                            <p>"Book ký túc xá ở đây là lựa chọn sáng suốt của mình khi bắt đầu con đường học đại học. Thật sự rất cảm ơn DormBOO."</p>
                            <h5 class="mb-1">Minh Tuan</h5>
                            <span class="fst-italic">FPT Student</span>
                        </div>
                    </div>
                    <div class="testimonial-item text-center">
