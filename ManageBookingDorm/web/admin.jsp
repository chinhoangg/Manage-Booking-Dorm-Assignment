            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <ul class="list-style-none">
                        <li class="d-flex no-block card-body"> <i class="fa fa-leaf w-30px m-t-5" style="margin-right: 10px"></i>
                        ...
                        <li class="d-flex no-block card-body border-top"> <i class="fa fa-question-circle w-30px m-t-5" style="margin-right: 10px"></i>
