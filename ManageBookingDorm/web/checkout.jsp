<%-- 
    ...
    Created on : Mar 13, 2022, 10:27:14 AM
    Author     : chinhoag
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4" style="border: 1px solid #ccc; border-radius: 5px; padding: 1rem">
                        ...
                        <form action="checkout" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary w-100">SEND FOR ME</button>
                        </form>
                    </div>
                </div>
            </div>
